...
--
-- Date Created : Tuesday, November 03, 2015 09:52:18
...
-- 
-- TABLE: TrORDENARTICULO 
--

CREATE TABLE TrORDENARTICULO(
...
ALTER TABLE MaARTICULO ADD CONSTRAINT RefMaARTICULO253 
...
ALTER TABLE TrORDENARTICULO ADD CONSTRAINT RefMaARTICULO255 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaARTICULO(ncodarticulo)
;
