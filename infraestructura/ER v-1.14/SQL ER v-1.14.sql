...
--
-- Date Created : Wednesday, November 04, 2015 11:41:00
...
CREATE TABLE TrCOMPRA(
    ...
    ncodarticulo         INT         NOT NULL,
    ncodproveedor        INT         NOT NULL,
    ncantidadProducto    INTEGER,
    ntotalapagar         INTEGER,
    ntotalpagado         INTEGER,
    nsaldoapagar         INTEGER
)TYPE=INNODB
;
...
ALTER TABLE MaAPLICACION ADD CONSTRAINT RefMaMODULO275 
...
ALTER TABLE MaBITACORA ADD CONSTRAINT RefMaACCIONES273 
    FOREIGN KEY (ncodaccion)
    REFERENCES MaACCIONES(ncodaccion)
;

ALTER TABLE MaBITACORA ADD CONSTRAINT RefMaUSUARIO274 
    FOREIGN KEY (ncodusuario)
    REFERENCES MaUSUARIO(ncodusuario)
;

ALTER TABLE MaBITACORA ADD CONSTRAINT RefMaAPLICACION276 
...
ALTER TABLE MaCUENTA ADD CONSTRAINT RefTrDOCUMENTOS256 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE MaDETALLECOTIZACION ADD CONSTRAINT RefMaPRODUCTO170 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;

ALTER TABLE MaDETALLECOTIZACION ADD CONSTRAINT RefMaPRODUCTO252 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDETALLEFACTURA ADD CONSTRAINT RefMaPRODUCTO134 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDETALLEFACTURA ADD CONSTRAINT RefMaPRODUCTO251 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDETALLEPEDIDO ADD CONSTRAINT RefMaPRODUCTO172 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDETALLEPEDIDO ADD CONSTRAINT RefMaPRODUCTO250 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDOCPORPAGAR ADD CONSTRAINT RefMaPROVEEDOR259 
    FOREIGN KEY (ncodproveedor)
    REFERENCES MaPROVEEDOR(ncodproveedor)
;

ALTER TABLE MaDOCPORPAGAR ADD CONSTRAINT RefMaTIPODOCUMENTO264 
...
ALTER TABLE MaERROR ADD CONSTRAINT RefMaTIPOERROR270 
    FOREIGN KEY (ncodtipo)
    REFERENCES MaTIPOERROR(ncodtipo)
;

ALTER TABLE MaERROR ADD CONSTRAINT RefMaUSUARIO271 
    FOREIGN KEY (ncodusuario)
    REFERENCES MaUSUARIO(ncodusuario)
;

ALTER TABLE MaERROR ADD CONSTRAINT RefMaACCIONES272 
    FOREIGN KEY (ncodaccion)
    REFERENCES MaACCIONES(ncodaccion)
;

ALTER TABLE MaERROR ADD CONSTRAINT RefMaAPLICACION277 
    FOREIGN KEY (ncodaplicacion)
    REFERENCES MaAPLICACION(ncodaplicacion)
;
...
ALTER TABLE MaMATERIAL ADD CONSTRAINT RefMaPRODUCTO117 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaORDENCOMPRA ADD CONSTRAINT RefMaPRODUCTO163 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaORDENPRODUCCION ADD CONSTRAINT RefTrPROCESOORDEN143 
    FOREIGN KEY (ncodprocesoorden)
    REFERENCES TrPROCESOORDEN(ncodprocesoorden)
;

ALTER TABLE MaORDENPRODUCCION ADD CONSTRAINT RefTrSTATUSORDEN191 
...
ALTER TABLE MaPRODUCTO ADD CONSTRAINT RefMaLINEAARTICULO135 
    FOREIGN KEY (ncodlineaarticulo)
    REFERENCES MaLINEAARTICULO(ncodlineaarticulo)
;

ALTER TABLE MaPRODUCTO ADD CONSTRAINT RefMaTIPOARTICULO136 
    FOREIGN KEY (ncodtipoarticulo)
    REFERENCES MaTIPOARTICULO(ncodtipoarticulo)
;

ALTER TABLE MaPRODUCTO ADD CONSTRAINT RefMaPROVEEDOR140 
    FOREIGN KEY (ncodproveedor)
    REFERENCES MaPROVEEDOR(ncodproveedor)
;

ALTER TABLE MaPRODUCTO ADD CONSTRAINT RefMaPRODUCTO253 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;

ALTER TABLE MaPRODUCTO ADD CONSTRAINT RefMaUNIDAD285 
...
ALTER TABLE MaRECETA ADD CONSTRAINT RefMaORDENPRODUCCION222 
    FOREIGN KEY (ncodordenes)
    REFERENCES MaORDENPRODUCCION(ncodordenes)
;
...
ALTER TABLE MaUSOARTICULO ADD CONSTRAINT RefMaPRODUCTO120 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaUSUARIO ADD CONSTRAINT RefTrGRAFICA279 
    FOREIGN KEY (ncodgrafica)
    REFERENCES TrGRAFICA(ncodgrafica)
;
...
ALTER TABLE TrCOBRO ADD CONSTRAINT RefTrDOCUMENTOS139 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE TrCOMPRA ADD CONSTRAINT RefMaPRODUCTO238 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE TrDETALLECONCILIACION ADD CONSTRAINT RefTrDOCUMENTOS189 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaTIPOTRANSACCION111 
    FOREIGN KEY (ncodtipotransaccion)
    REFERENCES MaTIPOTRANSACCION(ncodtipotransaccion)
;

ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaCUENTA158 
    FOREIGN KEY (ncodcuenta)
    REFERENCES MaCUENTA(ncodcuenta)
;

ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaPROVEEDOR258 
    FOREIGN KEY (ncodproveedor)
    REFERENCES MaPROVEEDOR(ncodproveedor)
;

ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaDOCPORPAGAR260 
    FOREIGN KEY (ndocumento)
    REFERENCES MaDOCPORPAGAR(ndocumento)
;

ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaTIPOTRANSACCION262 
    FOREIGN KEY (ncodtipotransaccion)
    REFERENCES MaTIPOTRANSACCION(ncodtipotransaccion)
;

ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaCUENTA263 
    FOREIGN KEY (ncodcuenta)
    REFERENCES MaCUENTA(ncodcuenta)
;
...
ALTER TABLE TrEXISTENCIA ADD CONSTRAINT RefMaPRODUCTO137 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE TrMOVIMIENTO ADD CONSTRAINT RefMaPRODUCTO144 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE TrORDENPRODUCTO ADD CONSTRAINT RefMaPRODUCTO255 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE TrPAGOPROVEEDOR ADD CONSTRAINT RefTrDOCUMENTOS164 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE TrPAGOS ADD CONSTRAINT RefTrDOCUMENTOS235 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;

ALTER TABLE TrPAGOS ADD CONSTRAINT RefTrDOCUMENTOS257 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE TrPAGOSALARIO ADD CONSTRAINT RefTrDOCUMENTOS154 
    FOREIGN KEY (ncodtransaccion)
    REFERENCES TrDOCUMENTOS(ncodtransaccion)
;
...
ALTER TABLE TrPEDIDO ADD CONSTRAINT RefMaPRODUCTO146 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE TrREPORTE ADD CONSTRAINT RefMaUSUARIO280 
    FOREIGN KEY (ncodusuario)
    REFERENCES MaUSUARIO(ncodusuario)
;
...
ALTER TABLE TrROLETOAPLICACION ADD CONSTRAINT RefMaROLUSUARIO268 
    FOREIGN KEY (ncodrole)
    REFERENCES MaROLUSUARIO(ncodrole)
;

ALTER TABLE TrROLETOAPLICACION ADD CONSTRAINT RefMaAPLICACION269 
    FOREIGN KEY (ncodaplicacion)
    REFERENCES MaAPLICACION(ncodaplicacion)
;
...
ALTER TABLE TrUNIDAD ADD CONSTRAINT RefMaUNIDAD282 
    FOREIGN KEY (ncodunidad)
    REFERENCES MaUNIDAD(ncodunidad)
;
...
ALTER TABLE TrUSUARIOTOAPLICACION ADD CONSTRAINT RefMaAPLICACION265 
    FOREIGN KEY (ncodaplicacion)
    REFERENCES MaAPLICACION(ncodaplicacion)
;

ALTER TABLE TrUSUARIOTOAPLICACION ADD CONSTRAINT RefMaUSUARIO278 
    FOREIGN KEY (ncodusuario)
    REFERENCES MaUSUARIO(ncodusuario)
;
...
ALTER TABLE TrUSUARIOTOROLE ADD CONSTRAINT RefMaUSUARIO266 
    FOREIGN KEY (ncodusuario)
    REFERENCES MaUSUARIO(ncodusuario)
;

ALTER TABLE TrUSUARIOTOROLE ADD CONSTRAINT RefMaROLUSUARIO267 
    FOREIGN KEY (ncodrole)
    REFERENCES MaROLUSUARIO(ncodrole)
;
