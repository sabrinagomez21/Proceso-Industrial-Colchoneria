...
namespace prueba1{
    ...
    public partial class Frm_Reporte : Form
    {
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            if(SUsuario=="Administrador"){Btn_AReporte.Visible = true;}else{Btn_AReporte.Visible = false;}
        ...
        private void Fnc_CreaReporte()
        {
            ...
            this.Size = new Size(390, 401);//Cambia el valor del Form a pequeño nuevamente
