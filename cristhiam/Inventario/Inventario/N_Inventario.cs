...
namespace Inventario{
    ...
    class N_Inventario
    {
        ...
        public void Insert_Inventario(E_Inventario pInventario)
        {
                ...
                if (string.IsNullOrWhiteSpace(pInventario.DI_orden) || string.IsNullOrWhiteSpace(pInventario.producto) || string.IsNullOrWhiteSpace(pInventario.DI_cantidad) || string.IsNullOrWhiteSpace(pInventario.DI_tipo))
                {
