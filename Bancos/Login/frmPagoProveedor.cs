...
namespace Login
{
    public partial class frmPagoProveedor : Form
    {
        ...
        {
            clasnegocio cnegocio = new clasnegocio();
            cnegocio.funconsultarRegistros("maproveedorbanco", "SELECT ncodproveedor as Codigo, cnombreproveedor as Nombre ,vestado as Estado, nsaldopendiente as Saldo  from maproveedorbanco WHERE cestado = 'ACTIVO' and cnombreproveedor LIKE '" + txtBuscar.Text + "%'", "consulta", dataGridView1);
        }
