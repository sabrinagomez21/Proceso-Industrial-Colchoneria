...
namespace Bancos
{
    public partial class frmConciliacion : Form
    {
        ...
        {
            clasnegocio cnegocio = new clasnegocio();
            cnegocio.funconsultarRegistrosCombo("ncodconcilicacion", "SELECT ncodconcilicacion as codigo from maencabezadoconciliacion where dfecha = '" + lblfeha.Text + "' and cencargado = '" + txtEncargado.Text + "' ", "codigo", cmbCodigo);
