    ...
    public partial class frmPermisosRol : Form
    {
        ...
        private void ActualizarLista()
        {
            try
            {
                ...
                comboRoles.ValueMember = "ncodrole";  // cada rol obtiene su id
        ...
        public void CargarAppAsignadas()
        {
            try
            {
                ...
                lbAppsAsignadas.ValueMember = "ncodaplicacion"; // a cada app le asigna un id
        ...
        private void mostrarPerfil()
        {
            try
            {
                ...
                // valuemember es el valor del list
                lbPerfiles.ValueMember = "ncodrole";
            }
            catch (Exception e)
            {
        ...
        private void CargarAppDispo()
        {
            try
            {
                ...
                lbAppsDisponibles.ValueMember = "ncodrole"; // le asigna a cada app un id
