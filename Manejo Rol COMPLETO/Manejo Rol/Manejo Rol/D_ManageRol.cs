    ...
    public class D_ManageRol
    {
        ...
        public static List<E_ManageRol> BuscarRegisRol(string pNombreRol)
        {
            ...
            try
            {
               ...
               "SELECT ncodrole, vnombrerole FROM MaROLUSUARIO where vnombrerole ='{0}'", pNombreRol), ConexionODBC.Conexion.ObtenerConexion());
        ...
        public static E_ManageRol Consultar(E_ManageRol eRol)
        {
            ...
            try
            {
                ...
                mySqlComando = new OdbcCommand(
                    string.Format("SELECT ncodrole as 'No.', vnombrerole as 'Nombre Role' FROM MaROLUSUARIO WHERE ncodrole = '{0}'", eRol.Id_Rol),
        ...
        public static DataTable ObtenerRegistros() // consulta para el grid
        {
            ...
            try
            {
                // query
                mySqlComando = new OdbcCommand(
                     string.Format("SELECT ncodrole as 'No.', vnombrerole as 'Nombre Role' FROM MaROLUSUARIO"),
                     ConexionODBC.Conexion.ObtenerConexion()
                 );
        ...
        public static int Actualizar(E_ManageRol pCliente)
        {
            ...
            {
                // query
                OdbcCommand comando = new OdbcCommand(string.Format("Update MaROLUSUARIO set vnombrerole='{0}' where ncodrole={1}",
