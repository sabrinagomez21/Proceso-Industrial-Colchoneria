...
namespace RRHH
{
    public partial class frmExtra1 : Form
    {
        ...
        public void desarrolloOrganizacionalToolStripMenuItem_Click(object sender, EventArgs e)
        {
             OpenFileDialog ofd = new OpenFileDialog();
        ...
        public void fODAToolStripMenuItem_Click(object sender, EventArgs e)
        { OpenFileDialog ofd = new OpenFileDialog();
       ...
       public void salirToolStripMenuItem_Click(object sender, EventArgs e)
        ...
        public void frmExtra1_Load(object sender, EventArgs e)
        {
