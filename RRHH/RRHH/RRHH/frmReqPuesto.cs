...
namespace RRHH
{
    public partial class frmReqPuesto : Form
    {
        ...
        private void frmReqPuesto_Load(object sender, EventArgs e)
        {
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            lbtipopuesto.Text = txtinvisible.Text;
        ...
        {
            TextBox[] datos = { txtnombre, txtapellido, txtestadocivil, txtgenero, txtedad, txtinvisible, txtinvisible, txtescolaridad, txtdpi, txttelefono, txtsalario };
            string tabla = "MaEMPLEADO";
            Boolean permiso = true;
            clasnegocio cn = new clasnegocio();
