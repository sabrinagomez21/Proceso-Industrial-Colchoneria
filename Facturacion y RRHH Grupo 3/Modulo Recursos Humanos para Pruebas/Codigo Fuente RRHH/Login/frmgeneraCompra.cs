...
namespace Login
{
    public partial class frmgeneraCompra : Form
    {
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            TextBox[] arraytexto = { txtrecibestatus };

            
            clasnegocio cn = new clasnegocio();
            string tabla = "maordencompra";
            Boolean permiso = true;
            string codigo = Convert.ToString(cmbidProveedor.Text);
            cn.EditarObjetos("maordencompra", permiso, arraytexto, codigo, "vstatusorden");
