...
-- Project :      DATA MODEL
--
-- Date Created : Thursday, November 05, 2015 18:55:26
...
CREATE TABLE TrCOMPRA(
    ncodarticulo         INT         NOT NULL,
    ncodproveedor        INT         NOT NULL,
    ncantidadProducto    CHAR(10),
    ntotalapagar         CHAR(10),
    ntotalpagado         CHAR(10),
    nsaldoapagar         CHAR(10),
...
ALTER TABLE MaCOTIZACION ADD CONSTRAINT RefMaCLIENTE101 
    FOREIGN KEY (ncodcliente)
    REFERENCES MaCLIENTE(ncodcliente)
;
...
ALTER TABLE MaDETALLECOTIZACION ADD CONSTRAINT RefMaCOTIZACION102 
    FOREIGN KEY (ncodcotizacion)
    REFERENCES MaCOTIZACION(ncodcotizacion)
;

ALTER TABLE MaDETALLECOTIZACION ADD CONSTRAINT RefMaPRODUCTO103 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaDETALLEPEDIDO ADD CONSTRAINT RefTrPEDIDO104 
    FOREIGN KEY (ncodpedido)
    REFERENCES TrPEDIDO(ncodpedido)
;

ALTER TABLE MaDETALLEPEDIDO ADD CONSTRAINT RefMaPRODUCTO105 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaENCABEZADOCONCILIACION ADD CONSTRAINT RefMaCUENTA109 
...
ALTER TABLE MaMONEDA ADD CONSTRAINT RefMaBANCO99 
    FOREIGN KEY (ncodbanco)
    REFERENCES MaBANCO(ncodbanco)
;
...
ALTER TABLE MaOBSERVACION ADD CONSTRAINT RefTrDETALLECONCILIACION111 
...
ALTER TABLE MaORDENCOMPRA ADD CONSTRAINT RefMaPRODUCTO97 
    FOREIGN KEY (ncodarticulo)
    REFERENCES MaPRODUCTO(ncodarticulo)
;
...
ALTER TABLE MaORDENPRODUCCION ADD CONSTRAINT RefTrPROCESOORDEN77 
    FOREIGN KEY (ncodprocesoorden)
    REFERENCES TrPROCESOORDEN(ncodprocesoorden)
;

ALTER TABLE MaORDENPRODUCCION ADD CONSTRAINT RefTrSTATUSORDEN110 
...
ALTER TABLE MaRECETA ADD CONSTRAINT RefMaORDENPRODUCCION4 
...
ALTER TABLE TrDESEMPENIO ADD CONSTRAINT RefMaEMPLEADO106 
    FOREIGN KEY (ncodempleado)
    REFERENCES MaEMPLEADO(ncodempleado)
;
...
ALTER TABLE TrDETALLECONCILIACION ADD CONSTRAINT RefMaENCABEZADOCONCILIACION107 
    FOREIGN KEY (ncodconcilicacion)
    REFERENCES MaENCABEZADOCONCILIACION(ncodconcilicacion)
;

ALTER TABLE TrDETALLECONCILIACION ADD CONSTRAINT RefTrDOCUMENTOS108 
    FOREIGN KEY (ncoddocumento)
    REFERENCES TrDOCUMENTOS(ncoddocumento)
;
...
ALTER TABLE TrDOCUMENTOS ADD CONSTRAINT RefMaCUENTA94 
    FOREIGN KEY (ncodcuenta)
    REFERENCES MaCUENTA(ncodcuenta)
;
...
ALTER TABLE TrPAGOPROVEEDOR ADD CONSTRAINT RefMaPROVEEDOR95 
    FOREIGN KEY (ncodproveedor)
    REFERENCES MaPROVEEDOR(ncodproveedor)
;

ALTER TABLE TrPAGOPROVEEDOR ADD CONSTRAINT RefTrDOCUMENTOS98 
    FOREIGN KEY (ncoddocumento)
    REFERENCES TrDOCUMENTOS(ncoddocumento)
;
...
ALTER TABLE TrPEDIDO ADD CONSTRAINT RefMaCLIENTE100 
    FOREIGN KEY (ncodcliente)
    REFERENCES MaCLIENTE(ncodcliente)
;
...
ALTER TABLE TrSOLICITUD ADD CONSTRAINT RefTrFAMILIA96 
