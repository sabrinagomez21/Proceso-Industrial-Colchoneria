    ...
    public class D_Rol: CAD
    {
        ...
        public static List<E_Rol> Buscar(string pNombre, string pApellido)
        {
          ...
          try
           ...
           "SELECT iidUsuario, vnombreUsuario, vapellidoUsuario, vemailUsuario FROM MAUSUARIO where vnombreUsuario ='{0}' or vapellidoUsuario='{1}'", pNombre, pApellido), CAD.ObtenerConexion());
        ...
        public static DataTable consultaPerfil()
        {
            ...
            OdbcDataAdapter da = new OdbcDataAdapter(consulta, CAD.ObtenerConexion());
            da.Fill(dt1);
            return dt1;
        }
        #endregion
